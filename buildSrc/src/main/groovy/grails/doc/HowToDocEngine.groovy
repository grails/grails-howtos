 ...
 * @since 1.2
 */
class HowToDocEngine extends BaseRenderEngine implements WikiRenderEngine {
    ...
    def engineProperties = new Properties()

    HowToDocEngine(InitialRenderContext context) {
        super(context)
